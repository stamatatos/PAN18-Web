...
def evaluate_all(path_collection,path_answers):
    ...
    for problem in problems:
        scores.append(evaluate(path_collection+os.sep+problem+os.sep+'ground-truth.json',path_answers+os.sep+'answers-'+problem+'.json'))
    logging.info('Overall score: %f', sum(scores)/len(scores))
